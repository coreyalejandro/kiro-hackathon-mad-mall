...
export default function UserProfile({ userData, onSave, onDeleteAccount, loading = false, error }: UserProfileProps) {
  ...
  const renderProfileTab = () => (
    <SpaceBetween size="l">
      ...
      <Header variant="h4">Health Journey</Header>
  ...
  const renderPrivacyTab = () => (
    <SpaceBetween size="l">
      ...
      <Header variant="h4">Data & Account</Header>
      
      <Box padding="l" className="kadir-nelson-secondary">
        <SpaceBetween size="s">
          <Header variant="h5">Account Actions</Header>
          <Box>
      ...
      <Box padding="l" className="kadir-nelson-gradient-warm">
        <SpaceBetween size="s">
          <Header variant="h5" color="text-status-error">Danger Zone</Header>
          <Box>
