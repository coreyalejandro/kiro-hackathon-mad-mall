    ...
    <div>
      ...
      <Container>
        ...
        <div className="interactive-grid">
          <Grid gridDefinition={[{ colspan: 6 }, { colspan: 6 }]}>
            {/* Peer Circles */}
            <div 
              className="kadir-nelson-gradient-warm mall-section-card ripple-effect card-container"
            ...
            {/* Comedy Lounge */}
            <div 
              className="kadir-nelson-gradient-sage mall-section-card ripple-effect card-container"
        ...
        <div className="interactive-grid">
          <Grid gridDefinition={[{ colspan: 4 }, { colspan: 4 }, { colspan: 4 }]}>
            {/* Story Booth */}
            <div 
              className="kadir-nelson-gradient-earth mall-section-card ripple-effect card-container"
            ...
            {/* Marketplace */}
            <div 
              className="kadir-nelson-accent mall-section-card ripple-effect card-container"
            ...
            {/* Resource Hub */}
            <div 
              className="kadir-nelson-secondary mall-section-card ripple-effect card-container"
      ...
      <Container>
        ...
        <div className="interactive-grid">
          <Grid gridDefinition={[{ colspan: 4 }, { colspan: 4 }, { colspan: 4 }]}>
            <div 
              className="kadir-nelson-gradient-warm highlight-card card-container"
            ...
            <div 
              className="kadir-nelson-gradient-sage highlight-card card-container"
              onClick={() => {
            ...
            <div 
              className="kadir-nelson-gradient-earth highlight-card card-container"
              onClick={() => {
