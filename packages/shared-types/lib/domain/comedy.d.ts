...
export type ComedyType = 'video' | 'audio' | 'text' | 'meme' | 'gif' | 'interactive';
export type ComedyCategory = 'medication_management' | 'medical_humor' | 'daily_life' | 'family_dynamics' | 'workplace_humor' | 'dating_relationships' | 'self_care_fails' | 'doctor_visits' | 'symptom_struggles' | 'community_inside_jokes';
export type TherapeuticFocus = 'stress_relief' | 'anxiety_relief' | 'normalizing_experience' | 'community_bonding' | 'mood_lifting' | 'perspective_shift' | 'coping_mechanism' | 'empowerment';
export type ComedyStatus = 'draft' | 'published' | 'featured' | 'archived' | 'flagged' | 'removed';
...
//# sourceMappingURL=comedy.d.ts.map