...
export type UserEvent = UserRegisteredEvent | UserEmailVerifiedEvent | UserProfileUpdatedEvent | UserPreferencesUpdatedEvent | UserDeactivatedEvent | UserReactivatedEvent | UserDeletedEvent | UserLoggedInEvent | UserLoggedOutEvent | UserOnboardingCompletedEvent | UserEngagementEvent | UserMilestoneAchievedEvent | UserFollowedEvent | UserUnfollowedEvent | UserBlockedEvent | UserUnblockedEvent | UserReportedEvent | UserModeratedEvent | UserVerificationRequestedEvent | UserVerifiedEvent | UserVerificationRejectedEvent;
