...
export interface GetCircleMembersResponse extends ListResponse<CircleMember & {
    user: {
        id: string;
        displayName: string;
        avatar?: string;
...
export interface GetJoinRequestsResponse extends ListResponse<CircleJoinRequest & {
    user: {
        id: string;
        displayName: string;
        avatar?: string;
