...
export interface LikeResourceResponse extends ApiResponse<{ liked: boolean; totalLikes: number }> {}

export interface SaveResourceRequest {
  resourceId: string;
}

export interface SaveResourceResponse extends ApiResponse<{ saved: boolean }> {}
...
export interface RateResourceResponse extends ApiResponse<{ averageRating: number; ratingCount: number }> {}
