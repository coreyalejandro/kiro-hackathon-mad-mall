...
export interface LikeStoryResponse extends ApiResponse<{ liked: boolean; totalLikes: number }> {}

export interface SaveStoryRequest {
  storyId: string;
}

export interface SaveStoryResponse extends ApiResponse<{ saved: boolean }> {}
