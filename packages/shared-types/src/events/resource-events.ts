...
// Resource Recommendation Events
...
export type ResourceDomainEvent = 
  ...
  | ResourceCollectionCreatedEvent
  | ResourceAddedToCollectionEvent
  | ResourceCommentedEvent
  | ResourceFlaggedEvent
  | ResourceModeratedEvent
  | ResourceFeaturedEvent;

export type ResourceIntegrationEvent = 
  | ResourceViewedEvent
  | ResourceStartedEvent
  | ResourceProgressUpdatedEvent
  | ResourceRecommendedEvent;
