...
export type SystemEvent = 
  ...
  | SystemDeploymentStartedEvent
  | SystemDeploymentCompletedEvent
  | SystemConfigurationChangedEvent
  | SystemSecurityAlertEvent
  | SystemAuditEvent
  | SystemBackupStartedEvent
  | SystemBackupCompletedEvent
  | SystemDataMigrationEvent
