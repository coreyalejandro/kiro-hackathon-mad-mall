...
// Business Recommendation Events
...
export type BusinessDomainEvent = 
  ...
  | BusinessVerificationRejectedEvent
  | ProductAddedEvent
  | ProductUpdatedEvent
  | ProductRemovedEvent
  | BusinessReviewedEvent
  | ProductReviewedEvent
  | ReviewRespondedEvent;

export type BusinessIntegrationEvent = 
  | BusinessViewedEvent
  | BusinessContactedEvent
  | ProductViewedEvent
  | BusinessRecommendedEvent;
