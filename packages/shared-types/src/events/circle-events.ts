...
// Union type for all circle events
export type CircleEvent = 
  ...
  | CircleMemberLeftEvent
  | CircleMemberRoleChangedEvent
  | CircleMemberBannedEvent
  | CircleMemberUnbannedEvent
  | CircleInvitationSentEvent
  | CircleInvitationAcceptedEvent
  | CircleInvitationDeclinedEvent
  | CircleInvitationExpiredEvent
  | CircleJoinRequestedEvent
  | CircleJoinRequestApprovedEvent
  | CircleJoinRequestRejectedEvent
  | CircleActivityEvent
  | CircleMilestoneAchievedEvent
  | CircleReportedEvent
  | CircleModeratedEvent
  | CircleFeaturedEvent
  | CircleUnfeaturedEvent;