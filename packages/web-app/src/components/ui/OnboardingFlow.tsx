    ...
    <SpaceBetween size="l">
      ...
      >
        <Multiselect
          ...
          onChange={({ detail }) => 
            updateData('primaryGoals', detail.selectedOptions.map(opt => opt.value as UserGoal))
          }
          options={[
    ...
    <SpaceBetween size="l">
      ...
      >
        <RadioGroup
          ...
          onChange={({ detail }) => updateData('communicationStyle', detail.value as CommunicationStyle)}
          items={[
    ...
    <SpaceBetween size="l">
      ...
      >
        <RadioGroup
          ...
          onChange={({ detail }) => updateData('diagnosisStage', detail.value as DiagnosisStage)}
          items={[
      ...
      >
        <Multiselect
          ...
          onChange={({ detail }) => 
            updateData('supportNeeds', detail.selectedOptions.map(opt => opt.value as SupportNeed))
          }
          options={[
            { label: 'Newly diagnosed support', value: 'newly_diagnosed_support' },
            { label: 'Anxiety management', value: 'anxiety_management' },
            { label: 'Medication management', value: 'medication_management' },
            { label: 'Workplace wellness', value: 'workplace_wellness' },
            { label: 'Family and relationships', value: 'family_relationships' },
            { label: 'Healthcare advocacy', value: 'healthcare_advocacy' },
            { label: 'Nutrition and lifestyle', value: 'nutrition_lifestyle' },
